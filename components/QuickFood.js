      ...
      <ScrollView horizontal showsHorizontalScrollIndicator="false">
        {data.map((item,index) => (
          <Pressable style={{margin:10}} key={index}>
            <ImageBackground imageStyle={{borderRadius:6}} style={{aspectRatio:5/6,height:170}} source={{url:item.image}}>
              <Text
                style={{
                  position:"absolute",
                  bottom:10,
            ...
            <Text style={{marginTop:19,fontSize:16,fontWeight:"500",marginTop:3}}>{item.name}</Text>
